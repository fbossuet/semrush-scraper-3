...
async function updateDatabase() {
  ...
  try {
    ...
    // Extraction de toutes les données sur 10 pages via la méthode scrapeMultiplePages
    logProgress('📋 Extraction de 30 pages via scrapeMultiplePages...');
    const onlineData = await extractor.scrapeMultiplePages(30);
