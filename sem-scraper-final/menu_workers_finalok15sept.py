...
class WorkersMenu:
    ...
    def print_main_menu(self):
        ...
        print("\n📋 MENU PRINCIPAL:")
        print("1. 🚀 Lancer les workers")
        print("2. 🧹 Nettoyer les locks")
        print("3. 📁 Voir les fichiers récents")
        print("4. 🔍 Voir les logs")
        print("5. 📈 Monitoring en temps réel")
        print("6. 📊 Statistiques par statut")
    ...
    def get_status_choice(self) -> str:
        ...
        print("3. 🌐 Toutes les boutiques éligibles")
    ...
    def show_help(self):
        ...
        print("   1. 🚀 Lancer les workers - Démarre le scraping")
        print("   2. 🧹 Nettoyer les locks - Supprime les fichiers de lock")
        print("   3. 📁 Fichiers récents - Liste les fichiers récents")
        print("   4. 🔍 Logs - Affiche les logs disponibles")
        print("   5. 📈 Monitoring temps réel - Surveillance en direct")
        print("   6. 📊 Statistiques par statut - Affiche les boutiques par statut")
        print("   7. ⚙️ Configuration - Vérifie la configuration")
        print("   8. 📖 Aide - Affiche cette aide")
        print("   9. 👋 Quitter - Ferme le menu")
        print()
    ...
    async def run_menu(self):
        ...
        while True:
            try:
                ...
                if choice == 1:  # Lancer les workers
                ...
                elif choice == 2:  # Nettoyer les locks
                    self.clean_locks()
                
                elif choice == 3:  # Fichiers récents
                    self.show_recent_files()
                
                elif choice == 4:  # Logs
                    self.show_logs()
                
                elif choice == 5:  # Monitoring en temps réel
                    self.show_realtime_monitoring()
                
                elif choice == 6:  # Statistiques par statut
