...
class ShopRepository:
    ...
    def get_shops_to_scrape(self, limit: Optional[int] = None, offset: int = 0) -> List[Shop]:
        """
        Retrieve shops that need to be scraped.
        NEW CRITERIA: shops.scraping_status != 'failed' AND details_scraping_status = 'details_extracted' AND analytics.scraping_status IS NULL
        ...
        try:
            ...
            with sqlite3.connect(str(db_path)) as conn:
                ...
                # Query shops that are ready for Noxtools scraping
                # CORRECT CRITERIA: shops.scraping_status ≠ "failed", details_scraping_status = "details_extracted", analytics.scraping_status = NULL
                query = """
